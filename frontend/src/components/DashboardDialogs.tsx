/**
 * Modais do dashboard — registrar transação e editar orçamento mensal.
...
import type { ApiCategory } from "@/lib/api"; // Tipo de categoria da API
...
/** Modal para registrar gasto ou receita manual no dashboard. */
